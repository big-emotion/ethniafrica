...
export const NOMMER_BIBLIOGRAPHY: Record<SourceKey, DossierSource> = {
  ...
  "afrik-pays-ben": {
    ...
    sourceKind: "academic",
    notes:
      "Atteste la date — 30 novembre 1975 — et le contexte : Kérékou, au pouvoir depuis le coup d'État du 26 octobre 1972, engage à partir de 1974 une politique marxiste-léniniste qui subordonne les appartenances ethno-régionales. Précise aussi ce que la première rédaction de ce chapitre manquait : « Bénin » n'était associé à aucun groupe du territoire, et le golfe du Bénin borde la côte — le nom avait donc un ancrage géographique local, pas seulement un emprunt lointain.",
    discoveredVia: [],
  },
  "afrik-pays-gha": {
    sourceKey: "afrik-pays-gha",
    title:
      "From Gold Coast to Ghana: History, Memory and the Naming of a Nation",
    authors: [],
    publicationYear: 2026,
    publisher: "Citi Newsroom",
    url: "https://www.citinewsroom.com/2026/03/from-gold-coast-to-ghana-history-memory-and-the-naming-of-a-nation/",
    standing: "referenced",
    sourceKind: "academic",
    notes:
      "Atteste le 6 mars 1957 et confirme le point du chapitre : l'empire du Ghana se trouvait dans le Soudan occidental, sur ce qui est aujourd'hui le sud de la Mauritanie et l'ouest du Mali, et les deux territoires ne se recouvrent jamais. Rappelle aussi que le choix résulte de décennies de réflexion d'enseignants et de lettrés de la Gold Coast sur l'étiquette coloniale, et non d'une décision isolée de Nkrumah.",
    discoveredVia: [],
  },
  ...
  "civil-registration-surnames": {
    ...
    sourceKind: "academic",
    notes:
      "L'ouvrage qui donne son cadre à ce chapitre : un État cherche à rendre ses sujets lisibles, et le nom de famille permanent est l'un des instruments de cette lisibilité, au même titre que le recensement, la langue unifiée et les unités de mesure standard. C'est ce qui autorise le chapitre à parler d'artefact administratif plutôt que de survivance. L'adresse pointe la notice faute de numérisation en accès libre ; l'ouvrage lui-même est la source, et l'édition Yale 1998 est la référence.",
    discoveredVia: [],
  },
  "native-administration-act-1927": {
    sourceKey: "native-administration-act-1927",
    title: "Native Administration Act, 1927 (Afrique du Sud)",
    ...
    notes:
      "L'instrument colonial concret que le cadre de Scott appelait : sous l'administration britannique, les lois sur les laissez-passer et l'impôt rendent le nom de famille fixe obligatoire, les chefs étant chargés de fournir des noms pour les registres. Rencontré dans un commentaire de presse sud-africain, pas dans le texte de loi — c'est ce qu'il reste à vérifier, et le chapitre ne cite pas encore l'Act nommément pour cette raison.",
    discoveredVia: [],
  },
  ...
  "kente-nwentoma": {
    ...
    publicationYear: null,
    publisher: null,
    url: "https://adanwomase.com/kente/",
    standing: "unverified",
    sourceKind: "community",
    notes:
