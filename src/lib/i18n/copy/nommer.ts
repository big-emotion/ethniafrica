...
const en = {
  ...
  missingImposition:
    "The atlas records the origin of an exonym in free prose, never as a value. We can count records that use the word “administration”; we cannot count names that an administration imposed.",
  countryEtymologies:
    "The etymologies of the fifty-four countries are recorded in the atlas and backed by no source: the “The country” chapter presents them as a reading, never as a measurement.",
  ...
  vocabularyIntro:
    "Endonym, exonym, glossonym, ethnic reification: this dossier uses words that the site displayed without defining them anywhere. The glossary holds them, each with an example from the atlas — or with the reason why the atlas has none.",
...
const fr: NommerCopy = {
  ...
  missingImposition:
    "L’atlas enregistre l'origine d'un exonyme en prose libre, jamais comme une valeur. On peut compter les pages qui emploient le mot « administration » ; on ne peut pas compter les noms qu'une administration a imposés.",
  countryEtymologies:
    "Les étymologies des cinquante-quatre pays sont renseignées dans l’atlas et adossées à aucune source : le chapitre « Le pays » les présente comme une lecture, jamais comme une mesure.",
  ...
  vocabularyIntro:
    "Endonyme, exonyme, glossonyme, réification ethnique : ce dossier emploie des mots que le site affichait sans les définir nulle part. Le glossaire les tient, chacun avec un exemple pris dans l’atlas — ou avec la raison pour laquelle l’atlas n’en a pas.",
