...
describe("English slugs (DEC-049)", () => {
  ...
  it("gives every page type its English segment", () => {
    const expected: Record<string, string> = {
      ...
      dossierProportions: "/en/dossiers/proportions",
      dossierPopulations: "/en/dossiers/populations",
      dossierRessources: "/en/dossiers/resources",
      dossierKongo: "/en/dossiers/kongo-kingdom",
      dossierLuba: "/en/dossiers/luba-empire",
