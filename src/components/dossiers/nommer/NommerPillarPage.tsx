      ...
      <div className="afh-accent-teal flex flex-col gap-afh-6xl">
        ...
        <section aria-labelledby="nommer-chapitres">
          ...
          <p className="mb-afh-lg mt-afh-md text-afh-body text-afh-text-soft">
            ...
            chapitre est un régime de dénomination différent, et le dernier
            existe parce que les quatre premiers laisseraient croire que la
            question ne concerne que les peuples.
          </p>
        ...
        <section aria-labelledby="nommer-limites">
          ...
          <div className="mt-afh-md flex flex-col gap-afh-md text-afh-body text-afh-text-soft">
            <p>
              ...
              : elles n’ont pas été examinées. C’est un chantier ouvert, et le
              taire derrière un pourcentage reviendrait à le compter comme un
              résultat.
            </p>
        ...
        <section aria-labelledby="nommer-glossaire">
          ...
          <p className="mb-afh-lg mt-afh-md text-afh-body text-afh-text-soft">
            ...
            emploie des mots que le site affichait sans les définir nulle part.
            Le glossaire les tient, chacun avec un exemple pris dans le corpus —
            ou avec la raison pour laquelle le corpus n’en a pas.
          </p>
