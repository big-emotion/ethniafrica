  ...
  return (
    ...
    >
      <div
        ...
        className="afh-shell flex flex-col gap-4 py-5 md:flex-row md:flex-wrap md:items-center md:justify-between md:gap-x-6 md:gap-y-3 xl:flex-row xl:flex-nowrap"
      >
