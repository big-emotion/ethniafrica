 ...
 *
 * Moved out of AboutPageContent (2026-09-01): a reading list is not part of
 * the project pitch, and burying 90-odd citations at the foot of the "À
 * propos" page pushed the page well past what a first-time visitor reads.
 * Reachable from the footer's "Le projet" rubric, beside Doctrine and À
 * propos — see SiteFooter.tsx and siteTree.ts.
 */
const content = {
  fr: {
    title: "Sources",
    ...
    <div className="mx-auto max-w-4xl space-y-8 px-4 py-8 text-afh-text">
      ...
      <section className="space-y-4">
        ...
        <div className="ml-4 space-y-2">
          <p className="font-semibold">{t.international.un.title}</p>
          <ul className="list-disc space-y-1">
            {renderSourceLink(
              t.international.un.item1.name,
              t.international.un.item1.url,
              t.international.un.item1.description
            )}
            {renderSourceLink(
              t.international.un.item2.name,
              t.international.un.item2.url
            )}
          </ul>
        </div>
        ...
        <div className="ml-4 space-y-2">
          ...
          <ul className="list-disc space-y-1">
            {renderSourceLink(
              t.international.cia.item1.name,
              t.international.cia.item1.url
            )}
            {renderSourceLink(
        ...
        <div className="ml-4 space-y-2">
          ...
          <ul className="list-disc space-y-1">
            {renderSourceLink(
              ...
              t.international.worldBank.item1.url
            )}
            {renderSourceLink(
              t.international.worldBank.item2.name,
              t.international.worldBank.item2.url
            )}
          </ul>
        </div>
        ...
        <div className="ml-4 space-y-2">
          ...
          <ul className="list-disc space-y-1">
            {renderSourceLink(
              ...
              t.international.unesco.item1.url
            )}
          </ul>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="ml-4 space-y-3">
          ...
          <div>
            <p className="font-semibold mb-2">{t.academic.journals.title}</p>
            <ul className="list-disc space-y-1">
              {t.academic.journals.items.map((journal) => (
                <li key={journal} className="ml-4">
                  {journal}
                </li>
              ))}
            </ul>
          ...
          {renderSourceLink(t.academic.unesco.name, t.academic.unesco.url)}
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc space-y-1 ml-4">
          {renderSourceLink(
            t.complementary.worldometer.name,
            t.complementary.worldometer.url
          )}
          {renderSourceLink(
            t.complementary.africanUnion.name,
            t.complementary.africanUnion.url
          )}
          {renderSourceLink(
            t.complementary.pewResearch.name,
