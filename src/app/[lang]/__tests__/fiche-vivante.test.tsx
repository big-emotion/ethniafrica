...
const FICHE_ROUTES: FicheRouteUnderTest[] = [
  ...
  },
  {
    ...
    // TonguePanel was the family's only citation printer; withdrawing it leaves
    // the fiche at scale and the record, and ScalePanel prints its corpus
    // source as plain text rather than as a link into the dossier.
    printsDossierCitation: false,
    gatesRecord: false,
    recordIsPageBody: true,
  },
