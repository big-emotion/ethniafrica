...
| `id`                                 | `invariant`       |                                                                                            |
| `vertical`                           | `invariant`       |                                                                                            |
| `rubric`                             | `invariant`       | The domain the menu files it under; the reader-facing word is the menu's, in both locales. |
| `readiness`                          | `invariant`       | Whether the dossier is offered; an editorial state, not prose.                             |
| `slug`                               | `invariant`       |                                                                                            |
| `title`                              | `translatable`    |                                                                                            |
